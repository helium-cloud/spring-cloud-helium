...
public class ConfigDataManager {
    ...
    private static final Map<String, ConfigTable> mapConfigTable = new ConcurrentHashMap<>();
    private static final Map<String, String> mapConfigText = new ConcurrentHashMap<>();

    public static void putConfigTable(String path, ConfigType configType, ConfigTable data) {
    ...
    public static ConfigTable getConfigTable(String path, ConfigType configType) {
