...
import static org.helium.common.config.configcenter.DynamicConfigurationFactory.getDynamicConfigurationFactory;
...
public interface DynamicConfiguration extends Configuration, AutoCloseable {
     ...
     * specifies at startup or 'helium' by default. This method will only register listener, which means it will not
     ...
     * such as a complete helium.properties file.
     */
    ...
    /**
     * This method are mostly used to get a compound config file, such as a complete helium.properties file.
     *
     * @revision 2.7.4
     */
     ...
     *
     * @return The default value is {@link #DEFAULT_GROUP "helium"}
     * @since 2.7.5
     */
