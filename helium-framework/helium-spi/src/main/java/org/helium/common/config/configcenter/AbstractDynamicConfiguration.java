...
public abstract class AbstractDynamicConfiguration implements DynamicConfiguration {
    ...
    public static final String PARAM_NAME_PREFIX = "helium.config-center.";
    ...
    protected static String getGroup(URL url) {
        ...
        return SPIStringUtils.isBlank(group) ? getParameter(url, CommonConstants.GROUP_KEY, DEFAULT_GROUP) : group;
    }
