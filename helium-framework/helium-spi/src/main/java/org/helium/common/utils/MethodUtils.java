...
import static org.helium.common.function.Streams.filterAll;
import static org.helium.common.utils.MemberUtils.isPrivate;
import static org.helium.common.utils.MemberUtils.isStatic;
import static org.helium.common.utils.ReflectUtils.EMPTY_CLASS_ARRAY;
import static org.helium.common.utils.ReflectUtils.resolveTypes;
...
//    }
    ...
    static Method findMethod(Class type, String methodName, Class<?>... parameterTypes) {
        Method method = null;
        try {
            if (type != null && SPIStringUtils.isNotEmpty(methodName)) {
