...
public class JavaCodeTest {
    ...
    String getSimpleCode() {
        ...
        code.append("package org.helium.common.compiler.support;");
    ...
    String getSimpleCodeWithImports() {
        ...
        code.append("import org.helium.common.compiler.support;\n");
    ...
    String getSimpleCodeWithWithExtends() {
        ...
        code.append("public class HelloServiceImpl" + SUBFIX.getAndIncrement() + " extends HelloServiceImpl0 {\n");
        code.append("   public String sayHello() { ");
