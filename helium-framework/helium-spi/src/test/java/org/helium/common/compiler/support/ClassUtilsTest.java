 ...
 */
package org.helium.common.compiler.support;
...
public class ClassUtilsTest {
    ...
    public void testNewInstance1() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.newInstance("org.helium.common.compiler.support.internal.HelloServiceInternalImpl"));
    }

    @Test
    public void testNewInstance2() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.newInstance("org.helium.common.compiler.support.internal.NotExistsImpl"));
    }

    @Test
    public void testForName() {
        ClassUtils.forName(new String[]{"org.helium.common.compiler.support"}, "HelloServiceImpl0");
    }

    @Test
    public void testForName1() {
        Assertions.assertThrows(IllegalStateException.class, () -> ClassUtils.forName(new String[]{"org.helium.common.compiler.support"}, "HelloServiceImplXX"));
    }
