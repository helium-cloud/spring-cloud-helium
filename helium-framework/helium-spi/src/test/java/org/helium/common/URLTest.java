...
import org.helium.common.utils.CollectionUtils;
...
public class URLTest {
    ...
    public void test_valueOf_WithProtocolHost() throws Exception {
        URL url = URL.valueOf("helium://10.20.130.230");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertNull(url.getUsername());
        assertNull(url.getPassword());
        assertEquals("10.20.130.230", url.getHost());
        assertEquals("10.20.130.230", url.getAddress());
        ...
        url = URL.valueOf("helium://10.20.130.230:20880/context/path");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertNull(url.getUsername());
        assertNull(url.getPassword());
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertEquals("admin", url.getUsername());
        assertEquals("hello1234", url.getPassword());
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880?version=1.0.0");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertEquals("admin", url.getUsername());
        assertEquals("hello1234", url.getPassword());
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertEquals("admin", url.getUsername());
        assertEquals("hello1234", url.getPassword());
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&noValue");
        assertURLStrDecoder(url);
        assertEquals("helium", url.getProtocol());
        assertEquals("admin", url.getUsername());
        assertEquals("hello1234", url.getPassword());
    ...
    // TODO Do not want to use spaces? See: helium-502, URL class handles special conventions for special characters.
    @Test
    ...
    public void test_getAddress() throws Exception {
        URL url1 = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
    ...
    public void test_equals() throws Exception {
        ...
        URL url2 = new URL("helium", "admin", "hello1234", "10.20.130.230", 20880, "context/path", params);
    ...
    public void test_toString() throws Exception {
        ...
        assertThat(url1.toString(), anyOf(
                equalTo("helium://10.20.130.230:20880/context/path?version=1.0.0&application=morgan"),
                equalTo("helium://10.20.130.230:20880/context/path?application=morgan&version=1.0.0"))
        );
    }
    ...
    public void test_toFullString() throws Exception {
        ...
        assertThat(url1.toFullString(), anyOf(
                equalTo("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan"),
                equalTo("helium://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&version=1.0.0"))
        );
    }

    @Test
    public void test_set_methods() throws Exception {
        URL url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
        assertURLStrDecoder(url);
    ...
    public void test_removeParameters() throws Exception {
        URL url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&k1=v1&k2=v2");
        assertURLStrDecoder(url);
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan&k1=v1&k2=v2");
    ...
    public void test_addParameter() throws Exception {
        URL url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?application=morgan");
    ...
    public void test_addParameter_sameKv() throws Exception {
        URL url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&k1=v1");
    ...
    public void test_addParameters() throws Exception {
        ...
        url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?application=morgan");
    ...
    public void test_addParameters_SameKv() throws Exception {
        ...
        {
            URL url = URL.valueOf("helium://admin:hello1234@10.20.130.230:20880/context/path?application=morgan&k1=v1&k2=v2");
    ...
    public void test_Anyhost() throws Exception {
        URL url = URL.valueOf("helium://0.0.0.0:20880");
        assertURLStrDecoder(url);
    ...
    public void test_Path() throws Exception {
        URL url = new URL("helium", "localhost", 20880, "////path");
        assertURLStrDecoder(url);
        assertEquals("path", url.getPath());
    }
    ...
    public void testGetServiceKey() {
        URL url1 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName");
        assertURLStrDecoder(url1);
        Assertions.assertEquals("org.helium.test.interfaceName", url1.getServiceKey());

        URL url2 = URL.valueOf("10.20.130.230:20880/org.helium.test.interfaceName?interface=org.helium.test.interfaceName");
        assertURLStrDecoder(url2);
        Assertions.assertEquals("org.helium.test.interfaceName", url2.getServiceKey());

        URL url3 = URL.valueOf("10.20.130.230:20880/org.helium.test.interfaceName?interface=org.helium.test.interfaceName&group=group1&version=1.0.0");
        assertURLStrDecoder(url3);
        Assertions.assertEquals("group1/org.helium.test.interfaceName:1.0.0", url3.getServiceKey());

        URL url4 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName");
        assertURLStrDecoder(url4);
        Assertions.assertEquals("context/path", url4.getPathKey());

        URL url5 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName&group=group1&version=1.0.0");
    ...
    public void testGetColonSeparatedKey() {
        URL url1 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName&group=group&version=1.0.0");
        assertURLStrDecoder(url1);
        Assertions.assertEquals("org.helium.test.interfaceName:1.0.0:group", url1.getColonSeparatedKey());

        URL url2 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName&version=1.0.0");
        assertURLStrDecoder(url2);
        Assertions.assertEquals("org.helium.test.interfaceName:1.0.0:", url2.getColonSeparatedKey());

        URL url3 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName&group=group");
        assertURLStrDecoder(url3);
        Assertions.assertEquals("org.helium.test.interfaceName::group", url3.getColonSeparatedKey());

        URL url4 = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName");
        assertURLStrDecoder(url4);
        Assertions.assertEquals("org.helium.test.interfaceName::", url4.getColonSeparatedKey());

        URL url5 = URL.valueOf("10.20.130.230:20880/org.helium.test.interfaceName");
        assertURLStrDecoder(url5);
        Assertions.assertEquals("org.helium.test.interfaceName::", url5.getColonSeparatedKey());

        URL url6 = URL.valueOf("10.20.130.230:20880/org.helium.test.interfaceName?interface=org.helium.test.interfaceName1");
        assertURLStrDecoder(url6);
        Assertions.assertEquals("org.helium.test.interfaceName1::", url6.getColonSeparatedKey());
    }
    ...
    public void testValueOf() {
        ...
        url = URL.valueOf("helium://10.20.130.230:20880");
        assertURLStrDecoder(url);

        url = URL.valueOf("helium://10.20.130.230:20880/path");
        assertURLStrDecoder(url);
    }
    ...
    public void testGetParameters() {
        URL url = URL.valueOf("10.20.130.230:20880/context/path?interface=org.helium.test.interfaceName&group=group&version=1.0.0");
...
//    }
    ...
    public void testEquals() {
        URL url1 = URL.valueOf("consumer://30.225.20.150/org.helium.rpc.service.GenericService?application=" +
                "helium-demo-api-consumer&category=consumers&check=false&helium=2.0.2&generic=true&interface=" +
                "org.helium.demo.DemoService&pid=7375&side=consumer&sticky=false&timestamp=1599556506417");
        URL url2 = URL.valueOf("consumer://30.225.20.150/org.helium.rpc.service.GenericService?application=" +
                "helium-demo-api-consumer&category=consumers&check=false&helium=2.0.2&generic=true&interface=" +
                "org.helium.demo.DemoService&pid=7375&side=consumer&sticky=false&timestamp=2299556506417");
        assertEquals(url1, url2);

        URL url3 = URL.valueOf("consumer://30.225.20.150/org.helium.rpc.service.GenericService?application=" +
                "helium-demo-api-consumer&category=consumers&check=false&helium=2.0.2&interface=" +
                "org.helium.demo.DemoService&pid=7375&side=consumer&sticky=false&timestamp=2299556506417");
        assertNotEquals(url2, url3);

        URL url4 = URL.valueOf("consumer://30.225.20.150/org.helium.rpc.service.GenericService?application=" +
                "helium-demo-api-consumer&category=consumers&check=true&helium=2.0.2&interface=" +
                "org.helium.demo.DemoService&pid=7375&side=consumer&sticky=false&timestamp=2299556506417");
    ...
    public void testEqualsWithProtocol() {
        URL url1 = URL.valueOf("helium://ad@min:hello@1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
        URL url2 = URL.valueOf("file://ad@min:hello@1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
        URL url3 = URL.valueOf("helium://ad@min:hello@1234@10.20.130.230:20880/context/path?version=1.0.0&application=morgan");
