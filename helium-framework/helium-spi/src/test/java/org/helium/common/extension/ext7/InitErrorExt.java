 ...
 */
package org.helium.common.extension.ext7;

import org.helium.common.URL;
import org.helium.common.extension.SPI;

/**
 * Test scenario for helium-144: extension load failure when third-party dependency doesn't exist. If extension is not
