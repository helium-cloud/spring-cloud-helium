...
import org.helium.framework.spi.task.TaskConsumerImpl;
import org.helium.framework.spi.task.TaskProducerFactoryImpl;
...
import org.helium.stack.rpc.HeliumRpcProtocolResolver;
...
public class Bootstrap extends AbstractBeanContextService {
	...
	private Bootstrap() {
		...
		loadBean(TaskConsumerImpl.class);
		loadBean(TaskProducerFactoryImpl.class);
	}
