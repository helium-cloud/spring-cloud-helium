...
public class ServiceImplementationAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
	...
	private void registerServiceBeans(Set<String> packagesToScan, BeanDefinitionRegistry registry) {
		...
		HeliumClassPathBeanDefinitionScanner scanner =
				new HeliumClassPathBeanDefinitionScanner(registry, environment, resourceLoader);
	...
	private void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
		...
		AbstractBeanDefinition serviceBeanDefinition =
				buildServiceBeanDefinition(taskImplementation, interfaceClass, annotatedServiceBeanName);

		// ServiceBean Bean name
		String beanName = taskImplementation.id();
	...
	private AbstractBeanDefinition buildServiceBeanDefinition(TaskImplementation taskImplementation, Class<?> interfaceClass,
															  String annotatedServiceBeanName) {

		BeanDefinitionBuilder builder = rootBeanDefinition(Task.class);
